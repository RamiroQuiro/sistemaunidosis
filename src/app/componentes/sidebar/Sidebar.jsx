...
import logoCepsi from "../../../../public/logoCepsi.svg";

export default function Sidebar() {
  return (
    <div className="absolute print:hidden top-24 left-0 bg-gray-200">
      <div className="flex flex-col sm:flex-row sm:justify-around z-30">
       
        <div className="h-screen w-64">
          <nav className="px-6 mt-10">
            <a
              className="flex items-center justify-start p-2 my-6 text-gray-600 transition-colors duration-200 hover:text-gray-800 bg-gray-50 hover:bg-gray-100 dark:hover:text-white dark:hover:bg-gray-600"
              href="#"
            >
              <svg
                width="20"
            ...
            {/* <div>
                    ...
                    <a className="flex items-center justify-start p-2 my-4 font-thin text-gray-500 transition-colors duration-200 hover:text-gray-800 dark:text-gray-400 hover:bg-gray-100 dark:hover:text-white dark:hover:bg-gray-600" href="#">
            ...
            <div>
              ...
              >
                ...
                <span className="mx-4 font-normal text-md">Nouveau client</span>
              </a>
              {/* <a className="flex items-center justify-start p-2 my-4 font-thin text-gray-500 transition-colors duration-200 hover:text-gray-800 dark:text-gray-400 hover:bg-gray-100 dark:hover:text-white dark:hover:bg-gray-600" href="#">
                        <span className="text-left">
                            <svg width="20" height="20" fill="currentColor" className="m-auto" viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
