    ...
    <div className="h-1/3 my-2 relative"><Image fill src={logoCepsi} alt="logoCepsi" /></div>
        <div className="h-screen w-64">
            <nav className="px-6 mt-10">
                <a className="flex items-center justify-start p-2 my-6 text-gray-600 transition-colors duration-200 hover:text-gray-800 bg-gray-50 hover:bg-gray-100 dark:hover:text-white dark:hover:bg-gray-600" href="#">
